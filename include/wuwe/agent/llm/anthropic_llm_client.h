#ifndef WUWE_AGENT_LLM_ANTHROPIC_LLM_CLIENT_H
#define WUWE_AGENT_LLM_ANTHROPIC_LLM_CLIENT_H
...
class anthropic_llm_client final : public llm_client {
public:
  explicit anthropic_llm_client(llm_client_config config);
  anthropic_llm_client(llm_client_config config, std::shared_ptr<http_client> http);
...
#endif // WUWE_AGENT_LLM_ANTHROPIC_LLM_CLIENT_H

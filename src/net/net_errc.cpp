...
public:
    ...
    bool equivalent(const std::error_code& ec, int condition) const noexcept final {
        ...
        case net_errc::timeout:
            return ec == transport_error::operation_timedout ||
                   ec == http_status_code::gateway_timeout;
        ...
        case net_errc::connection_failed:
            return ec == transport_error::couldnt_connect ||
                   ec == transport_error::send_error ||
                   ec == transport_error::recv_error ||
                   ec == transport_error::got_nothing ||
                   ec == transport_error::no_connection_available;
        case net_errc::tls_failed:
            return ec == transport_error::ssl_connect_error ||
                   ec == transport_error::ssl_certproblem ||
                   ec == transport_error::ssl_cipher ||
                   ec == transport_error::peer_failed_verification ||
                   ec == transport_error::use_ssl_failed ||
                   ec == transport_error::ssl_cacert_badfile ||
                   ec == transport_error::ssl_shutdown_failed ||
                   ec == transport_error::ssl_crl_badfile ||
                   ec == transport_error::ssl_issuer_error ||
        ...
        case net_errc::server_error:
            return ec == http_status_code::internal_server_error ||
                   ec == http_status_code::bad_gateway ||
                   ec == http_status_code::gateway_timeout;
